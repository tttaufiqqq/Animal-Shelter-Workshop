...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::connection('users')->create('cache_locks', function (Blueprint $table) {
            $table->string('key')->primary();
            $table->string('owner');
            $table->integer('expiration');
        });
    ...
    {
        Schema::connection('users')->dropIfExists('cache_locks');
        Schema::connection('users')->dropIfExists('cache');
    }
};
