<x-admin-layout>
    ...
    @if(isset($dbDisconnected) && count($dbDisconnected) > 0)
        <div class="mb-6 flex items-start gap-3 p-4 bg-yellow-50 border-l-4 border-yellow-400 rounded-lg">
            ...
            <div class="flex-1">
                ...
                <p class="text-sm text-yellow-700 mt-1">{{ count($dbDisconnected) }} database(s) unavailable. Some features may not work.</p>
            </div>
        </div>
    @endif
