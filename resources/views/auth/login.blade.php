...
<head>
    ...
    <title>Login - Pawfect Buddy</title>
                ...
                <div class="p-8 md:p-12 flex flex-col justify-center">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input id="password" class="block mt-1 w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-600 focus:border-transparent @error('password') border-red-500 @enderror" type="password" name="password" required autocomplete="current-password" />
                            @error('password')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
