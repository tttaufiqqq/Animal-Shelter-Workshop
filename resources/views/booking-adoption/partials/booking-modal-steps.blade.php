{{-- booking-modal-steps Orchestrator --}}
@php
...
@endphp
@include('booking-adoption.partials.booking-modal-steps.modal-shell')
@include('booking-adoption.partials.booking-modal-steps.modal-content')
